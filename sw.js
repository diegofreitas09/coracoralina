const CACHE_NAME='cora-2027-v51';
const ASSETS=[
...
function forceScripts(html){
  const scripts=[
    [/<script[^>]+src=["'][^"']*reajustes-2027\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./reajustes-2027.js?v=32'></script>"],
    [/<script[^>]+src=["'][^"']*mensalidades-2027-v2\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./mensalidades-2027-v2.js?v=28'></script>"],
    [/<script[^>]+src=["'][^"']*fechamento-nav-fix\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./fechamento-nav-fix.js?v=27'></script>"],
    [/<script[^>]+src=["'][^"']*relatorio-fechamento-2027\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./relatorio-fechamento-2027.js?v=25'></script>"],
    [/<script[^>]+src=["'][^"']*relatorio-fechamento-layout-v2\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./relatorio-fechamento-layout-v2.js?v=24'></script>"],
    [/<script[^>]+src=["'][^"']*listas-material-2027\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./listas-material-2027.js?v=24'></script>"],
    [/<script[^>]+src=["'][^"']*sync-planilha-2027\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./sync-planilha-2027.js?v=22'></script>"],
    [/<script[^>]+src=["'][^"']*fechamento-sti-v29\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./fechamento-sti-v29.js?v=22'></script>"],
    [/<script[^>]+src=["'][^"']*pdf-fechamento-fix-v30\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./pdf-fechamento-fix-v30.js?v=21'></script>"],
    [/<script[^>]+src=["'][^"']*receita-espelho-fechamento-v32\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./receita-espelho-fechamento-v32.js?v=19'></script>"],
    [/<script[^>]+src=["'][^"']*alunos-ajuste-v35\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./alunos-ajuste-v35.js?v=16'></script>"],
    [/<script[^>]+src=["'][^"']*visao-geral-fachada-v36\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./visao-geral-fachada-v36.js?v=15'></script>"],
    [/<script[^>]+src=["'][^"']*materiais-gestao-v38\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./materiais-gestao-v38.js?v=13'></script>"],
    [/<script[^>]+src=["'][^"']*mensalidades-portfolio-v40\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./mensalidades-portfolio-v40.js?v=11'></script>"],
    [/<script[^>]+src=["'][^"']*tab-router-fix-v41\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./tab-router-fix-v41.js?v=10'></script>"],
    [/<script[^>]+src=["'][^"']*cora-gestao-brand-v45\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./cora-gestao-brand-v45.js?v=7'></script>"],
    [/<script[^>]+src=["'][^"']*panfleto-premium-v48\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./panfleto-premium-v48.js?v=6'></script>"]
  ];
