const CACHE_NAME='cora-2027-v44';
const ASSETS=[
...
function forceScripts(html){
  const scripts=[
    [/<script[^>]+src=["'][^"']*reajustes-2027\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./reajustes-2027.js?v=26'></script>"],
    [/<script[^>]+src=["'][^"']*mensalidades-2027-v2\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./mensalidades-2027-v2.js?v=22'></script>"],
    [/<script[^>]+src=["'][^"']*fechamento-nav-fix\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./fechamento-nav-fix.js?v=21'></script>"],
    [/<script[^>]+src=["'][^"']*relatorio-fechamento-2027\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./relatorio-fechamento-2027.js?v=19'></script>"],
    ...
    [/<script[^>]+src=["'][^"']*visao-geral-fachada-v36\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./visao-geral-fachada-v36.js?v=9'></script>"],
    [/<script[^>]+src=["'][^"']*materiais-gestao-v38\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./materiais-gestao-v38.js?v=7'></script>"],
    [/<script[^>]+src=["'][^"']*mensalidades-portfolio-v40\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./mensalidades-portfolio-v40.js?v=5'></script>"],
    [/<script[^>]+src=["'][^"']*tab-router-fix-v41\.js[^"']*["'][^>]*><\/script>/ig,"<script src='./tab-router-fix-v41.js?v=4'></script>"]
  ];
