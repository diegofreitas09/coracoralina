...
self.addEventListener('fetch',e=>{
  ...
  if(['/reajustes-2027.js','/mensalidades-2027-v2.js','/fechamento-nav-fix.js','/relatorio-fechamento-2027.js','/relatorio-fechamento-layout-v2.js','/listas-material-2027.js','/sync-planilha-2027.js','/fechamento-sti-v29.js','/pdf-fechamento-fix-v30.js','/receita-espelho-fechamento-v32.js','/alunos-ajuste-v35.js','/visao-geral-fachada-v36.js','/materiais-gestao-v38.js'].some(x=>u.pathname.endsWith(x))){e.respondWith(fetch(e.request,{cache:'no-store'}));return;}
